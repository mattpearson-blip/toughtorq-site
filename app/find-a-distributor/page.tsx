  ...
  return (
    <>
      <PageHero
        ...
        text="Submit your location and product needs, and a ToughTorq contact will review your request and follow up accordingly."
      />
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-3xl border border-white/10 bg-neutral-950 p-5 transition hover:border-red-600 md:p-10">
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-white/80">
                Submit your information and application needs so the ToughTorq
                team can review the request and help direct you to the right
                support path.
              </p>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-white/10 bg-neutral-950 p-6 transition hover:border-red-600 md:p-8">
                ...
                <h3 className="mt-3 text-2xl font-semibold text-[#666666]">
                  Industrial coverage with practical follow-through
                </h3>
                <p className="mt-4 leading-8 text-white/75">
                  ToughTorq is focused on helping customers connect with the
                  right support path for product selection, application needs,
              ...
              <div className="rounded-3xl border border-white/10 bg-neutral-950 p-6 transition hover:border-red-600 md:p-8">
                ...
                <p className="mt-4 leading-8 text-white/75">
                  ...
                  wrenches, and broader ToughTorq product needs as the lineup
                  continues to expand.
                </p>
              </div>
